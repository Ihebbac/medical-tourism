...
export default function Header({ logoSrc, variant }) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0 && isSticky === false) {
        setIsSticky(true);
      } else if (window.scrollY === 0 && isSticky === true) {
        setIsSticky(false);
      }
    };
  ...
  return (
    <>
      <header
        className={`cs_site_header cs_style1 cs_sticky_header ${mobileToggle ? "cs_mobile_toggle_active" : ""} ${variant} ${
            ...
            <div className="cs_main_header_in">
                    ...
                    <li className="menu-item-has-children">
                      ...
                      <DropDown>
                        <ul>
                          ...
                          <li>
                            <Link to="/departments/department-details">Department Details</Link>
                          </li>
                          <li>
              ...
              <div className="cs_main_header_right">
                <div className="cs_toolbox">
                  ...
                  <button className="cs_toolbox_btn cs_sidebar_toggle_btn" type="button" onClick={() => setSideNav(!sideNav)}>
      ...
      <div className={`cs_sidenav ${sideNav ? "active" : ""}`}>
        <div className="cs_sidenav_overlay" onClick={() => setSideNav(!sideNav)} />
        <div className="cs_sidenav_in">
          <button className="cs_close" type="button" onClick={() => setSideNav(!sideNav)}>
          ...
          <IconBoxStyle11 title="Phone" subTitle="123-456-7890" iconSrc="/images/contact/icon_1.svg" />
          <Spacing md="30" lg="30" xl="30" />
          <IconBoxStyle11 title="Email" subTitle="hellocallcenter@gmail.com" iconSrc="/images/contact/icon_2.svg" />
          <Spacing md="30" lg="30" xl="30" />
          <IconBoxStyle11 title="Location" subTitle="123 Anywhere St., Any City, 12345" iconSrc="/images/contact/icon_3.svg" />
        ...
        <div className="cs_header_search_in">
          <div className="container">
            <div className="cs_header_search_box">
              ...
              <button className="cs_close" type="button" onClick={() => setSearchToggle(!searchToggle)}>
                <img src="/images/icons/close.svg" alt="Close" />
              </button>
            </div>
          </div>
        </div>
        <div className="cs_sidenav_overlay" onClick={() => setSearchToggle(!searchToggle)} />
      </div>
    </>
  );
}
