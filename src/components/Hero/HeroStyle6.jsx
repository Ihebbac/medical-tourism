...
export default function HeroStyle6({ title, subTitle, bgUrl, imgUrl, videoBtnText, videoUrl, funfactList, btnText, btnUrl }) {
  return (
        ...
        <>
          <div className="container">
            <div className="cs_hero_text">
              <h1 className="cs_hero_title cs_white_color cs_fs_84"> {parse(title)}</h1>
              <div className="cs_hero_text_in">
                ...
                <p className="cs_hero_subtitle cs_white_color" style={{ fontSize: "25px", textShadow: "1px 1px 2px black" }}>
                  {subTitle}
                </p>
              </div>
            </div>
            <SocialWidget className="cs_hero_patents" />
            ...
            <div className="cs_hero_bottom">
              <div className="cs_hero_bottom_left">
                <div className="cs_hero_btn_wrap">
                  <VideoModal videoUrl={videoUrl} videoBtnText={videoBtnText} variant="cs_white_color" />
                </div>
              </div>
